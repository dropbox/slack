...
func (api *Client) adminRequest(ctx context.Context, client HTTPRequester, method string, teamName string, values url.Values, debug bool) (*adminResponse, error) {
	adminResponse := &adminResponse{}
	err := api.callSlackMethodWebApiFormat(ctx, method, teamName, values, adminResponse)
	if err != nil {
		return nil, err
	}
...
func (api *Client) DisableUserContext(ctx context.Context, teamName string, uid string) error {
	...
	_, err := api.adminRequest(ctx, api.httpclient, "setInactive", teamName, values, api.debug)
	if err != nil {
...
func (api *Client) InviteGuestContext(ctx context.Context, teamName, channel, firstName, lastName, emailAddress string) error {
	...
	_, err := api.adminRequest(ctx, api.httpclient, "invite", teamName, values, api.debug)
	if err != nil {
...
func (api *Client) SetRegularContext(ctx context.Context, teamName, user string) error {
	...
	_, err := api.adminRequest(ctx, api.httpclient, "setRegular", teamName, values, api.debug)
	if err != nil {
...
func (api *Client) SendSSOBindingEmailContext(ctx context.Context, teamName, user string) error {
	...
	_, err := api.adminRequest(ctx, api.httpclient, "sendSSOBind", teamName, values, api.debug)
	if err != nil {
...
func (api *Client) SetUltraRestrictedContext(ctx context.Context, teamName, uid, channel string) error {
	...
	_, err := api.adminRequest(ctx, api.httpclient, "setUltraRestricted", teamName, values, api.debug)
	if err != nil {
...
func (api *Client) SetRestrictedContext(ctx context.Context, teamName, uid string) error {
	...
	_, err := api.adminRequest(ctx, api.httpclient, "setRestricted", teamName, values, api.debug)
	if err != nil {
